...
import PostsComponent from '../Feature/Posts'
...
export default function UserInfoComponent({UserInfo}) {
  ...
  const list = (anchor) => (
    ...
    ></div>
      <Paper className={classes.paper} key={UserInfo.id}>
      ...
      <PostsComponent UserInfo={UserInfo} toggleDrawer={toggleDrawer('right',false)} />
      </>
  );
